(self["webpackChunkwebee_personas"] = self["webpackChunkwebee_personas"] || []).push([["common"],{
...
let GroupsService = class GroupsService {
    ...
    getGroups() {
        return this.allGroups = this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.wordpress.url_api + 'group');
    }
    getOne(id) {
        return this.allGroups = this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.wordpress.url_api + 'group/' + id);
    }
    create(group, token) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_0__.environment.wordpress.url_api + 'group', group, { headers: { Authorization: 'Bearer ' + token } });
    }
};
GroupsService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__.HttpClient }
];
GroupsService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
